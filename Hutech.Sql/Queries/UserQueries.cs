...
namespace Hutech.Sql.Queries
{
    public static class UserQueries
    {
        ...
        public static string PostUser => "Insert into UserDetail Values(@AspNetUserId,@UserTypeId,@FirstName,@LastName,@EmployeeId,@Email,@IsActive,@CreatedDate,@DateModifiedUtc,@LocationId,@DepartmentId,@Remark,@LoginValidityDays,@WindowsUserName,@UserstatusId,@RemarkForReject,@ApprovedBy,@ApprovedDate,@RejectedBy,@RejectedDate)";
