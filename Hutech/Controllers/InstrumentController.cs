                ...
                else
                {
                    ...
                    using (var client = new HttpClient())
                    {
                        ...
                        if (Res.IsSuccessStatusCode)
                        {
                            ...
                            {
                                string message= languageService.Getkey("Instrument Added Successfully");
                                TempData["message"] = message;
                ...
                else
                {
                    ...
                    using (var client = new HttpClient())
                    {
                        ...
                        if (response.IsSuccessStatusCode)
                        {
                            ...
                            {
                                string message= languageService.Getkey("Instrument Updated Successfully");
                                TempData["message"] = message;
                                TempData["RedirectURl"] = "/Instrument/GetAllInstrument/";
                            }
                        }
            ...
            try
            {
                ...
                using (var client = new HttpClient())
                {
                    ...
                    if (response.IsSuccessStatusCode)
                    {
                        ...
                        {
                            string message= languageService.Getkey("Instrument Deleted Successfully");
                            TempData["message"] = message;
                            TempData["RedirectURl"] = "/Instrument/GetAllInstrument/";
                        }
                        //var message = root["value"].ToString();
