...
namespace Hutech.API
{
    public class EmailSenderService: IEmailSenderService
    {
        ...
        public void SendEmail(MessageServiceModel message)
        {
        ...
        public async Task SendEmailAsync(MessageServiceModel message)
        {
        ...
        private MimeMessage CreateEmailMessage(MessageServiceModel message)
        {
